...
class MyWindow(QMainWindow, Form):
    ...
    def capture_photo(self):
        ...
        if ret:
            ...
            image_folder = "D:/Users/Users/Python/Robot_Yolo/declaration/image"
            ...
            label_folder = "D:/Users/Users/Python/Robot_Yolo/declaration/labels"
    ...
    def declare_files(self):
        ...
        timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
        base_info_path = "D:/Users/Users/Python/Robot_Yolo/declaration/information"
        folder_path = os.path.join(base_info_path, timestamp)
        os.makedirs(folder_path, exist_ok=True)

        original_image_path = os.path.join("D:/Users/Users/Python/Robot_Yolo/declaration/image", self.image_file_name)
    ...
    def start_training(self):
        ...
        def run_training():
            model = YOLO("yolov8n.pt")  # 또는 기존 best.pt로 미세 조정
